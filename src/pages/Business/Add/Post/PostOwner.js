...
import { faLocationDot, faSearch, faStar, faTag } from '@fortawesome/free-solid-svg-icons';
...
function PostOwner({ userId }) {
    ...
    const handleImageClick = (postIndex, imageIndex) => {
        ...
        setBoxImages(true); // Giả sử setBoxImages là phương thức bạn dùng để mở Lightbox
    };
